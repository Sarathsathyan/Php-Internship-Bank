        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12">
                <div class="section-title">
                    <h2>10 Jobs are available for apply</h2>
                    <p>Lose away off why half led have near bed. At engage simple father of period others except</p>
                </div>
                <div class="single-job">
                    <div class="job-des">
                        <h3><a href="#">Software Engineer (Full Stack Web) - MoPub</a></h3>
                        <p>MoPub is the world’s largest mobile application advertising exchange and complete ad serving platform</p>
                    </div>
                ...
                <div class="single-job">
                    <div class="job-des">
                        <h3><a href="#">Full Stack Software Developer</a></h3>
                        <p>MoPub is the world’s largest mobile application advertising exchange and complete ad serving platform</p>
                    </div>
                    <div class="job-apply-btn">
                        <a href="#" class="bttn-small btn-fill">Apply now</a>
                ...
                <div class="single-job">
                    <div class="job-des">
                        <h3><a href="#">Software Developer ? Full Stack_RNC</a></h3>
                        <p>MoPub is the world’s largest mobile application advertising exchange and complete ad serving platform</p>
                    </div>
                    <div class="job-apply-btn">
                        <a href="#" class="bttn-small btn-fill">Apply now</a>
                ...
                <div class="single-job">
                    <div class="job-des">
                        <h3><a href="#">TITLE JR. FULL STACK DEVELOPER</a></h3>
                        <p>MoPub is the world’s largest mobile application advertising exchange and complete ad serving platform</p>
                    </div>
                    <div class="job-apply-btn">
                        <a href="#" class="bttn-small btn-fill">Apply now</a>
                ...
                <div class="single-job">
                    <div class="job-des">
                        <h3><a href="#">Web Application Developer</a></h3>
                        <p>MoPub is the world’s largest mobile application advertising exchange and complete ad serving platform</p>
                    </div>
                    <div class="job-apply-btn">
                        <a href="#" class="bttn-small btn-fill">Apply now</a>
